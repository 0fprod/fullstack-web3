...
import { NFTBought, NFTListed, NFTUnlisted } from '../generated/DevMarketplace/DevMarketplace';
...
export function createNFTBoughtEvent(
  ...
  nftBoughtEvent.parameters.push(
    new ethereum.EventParam('buyerAddress', ethereum.Value.fromAddress(buyerAddress))
  );
  nftBoughtEvent.parameters.push(
    new ethereum.EventParam('nftContractAddress', ethereum.Value.fromAddress(nftContractAddress))
  );
  nftBoughtEvent.parameters.push(
